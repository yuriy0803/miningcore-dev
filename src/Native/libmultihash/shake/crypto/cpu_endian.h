...
#define LOAD24LE(p) ( \
   ((uint32_tt)(((uint8_t *)(p))[0]) << 0)| \
   ((uint32_tt)(((uint8_t *)(p))[1]) << 8) | \
   ((uint32_tt)(((uint8_t *)(p))[2]) << 16))

//Load unaligned 24-bit integer (big-endian encoding)
#define LOAD24BE(p) ( \
   ((uint32_tt)(((uint8_t *)(p))[0]) << 16) | \
   ((uint32_tt)(((uint8_t *)(p))[1]) << 8) | \
   ((uint32_tt)(((uint8_t *)(p))[2]) << 0))
...
#define LOAD32LE(p) ( \
   ...
   ((uint32_tt)(((uint8_t *)(p))[1]) << 8) | \
   ((uint32_tt)(((uint8_t *)(p))[2]) << 16) | \
   ((uint32_tt)(((uint8_t *)(p))[3]) << 24))

//Load unaligned 32-bit integer (big-endian encoding)
#define LOAD32BE(p) ( \
   ((uint32_tt)(((uint8_t *)(p))[0]) << 24) | \
   ((uint32_tt)(((uint8_t *)(p))[1]) << 16) | \
   ((uint32_tt)(((uint8_t *)(p))[2]) << 8) | \
   ((uint32_tt)(((uint8_t *)(p))[3]) << 0))
...
#define STORE24LE(a, p) \
   ((uint8_t *)(p))[0] = ((uint32_tt)(a) >> 0) & 0xFFU, \
   ((uint8_t *)(p))[1] = ((uint32_tt)(a) >> 8) & 0xFFU, \
   ((uint8_t *)(p))[2] = ((uint32_tt)(a) >> 16) & 0xFFU

//Store unaligned 24-bit integer (big-endian encoding)
#define STORE24BE(a, p) \
   ((uint8_t *)(p))[0] = ((uint32_tt)(a) >> 16) & 0xFFU, \
   ((uint8_t *)(p))[1] = ((uint32_tt)(a) >> 8) & 0xFFU, \
   ((uint8_t *)(p))[2] = ((uint32_tt)(a) >> 0) & 0xFFU
...
#define STORE32LE(a, p) \
   ...
   ((uint8_t *)(p))[1] = ((uint32_tt)(a) >> 8) & 0xFFU, \
   ((uint8_t *)(p))[2] = ((uint32_tt)(a) >> 16) & 0xFFU, \
   ((uint8_t *)(p))[3] = ((uint32_tt)(a) >> 24) & 0xFFU

//Store unaligned 32-bit integer (big-endian encoding)
#define STORE32BE(a, p) \
   ((uint8_t *)(p))[0] = ((uint32_tt)(a) >> 24) & 0xFFU, \
   ((uint8_t *)(p))[1] = ((uint32_tt)(a) >> 16) & 0xFFU, \
   ((uint8_t *)(p))[2] = ((uint32_tt)(a) >> 8) & 0xFFU, \
   ((uint8_t *)(p))[3] = ((uint32_tt)(a) >> 0) & 0xFFU
...
#define SWAPINT32(x) ( \
   (((uint32_tt)(x) & 0x000000FFUL) << 24) | \
   (((uint32_tt)(x) & 0x0000FF00UL) << 8) | \
   (((uint32_tt)(x) & 0x00FF0000UL) >> 8) | \
   (((uint32_tt)(x) & 0xFF000000UL) >> 24))
...
#define htonl(value) swapInt32((uint32_tt) (value))
...
#define ntohl(value) swapInt32((uint32_tt) (value))
...
#define htole32(value) ((uint32_tt) (value))
...
#define letoh32(value) ((uint32_tt) (value))
...
#define htobe32(value) swapInt32((uint32_tt) (value))
...
#define betoh32(value) swapInt32((uint32_tt) (value))
...
uint32_tt swapInt32(uint32_tt value);
...
uint32_tt reverseInt32(uint32_tt value);
