...
int cshakeCompute(uint_t strength, const void *input, size_t inputLen,
   ...
   uint8_t *output, size_t outputLen)
{
   ...
   context = malloc(sizeof(CshakeContext));
...
int cshakeInit(CshakeContext *context, uint_t strength, const char_t *name,
