...
#define ETHASH_EPOCH_LENGTH 2102400
...
#define ETHASH_NUM_DATASET_ACCESSES 64
     ...
     */
    EXPORT union ethash_hash256 ethash_calculate_epoch_seed(int epoch_number) NOEXCEPT;

    EXPORT struct ethash_epoch_context *ethash_create_epoch_context(int epoch_number) NOEXCEPT;
     ...
     */
    EXPORT struct ethash_epoch_context_full *ethash_create_epoch_context_full(int epoch_number) NOEXCEPT;

    EXPORT void ethash_destroy_epoch_context(struct ethash_epoch_context *context) NOEXCEPT;

    EXPORT void ethash_destroy_epoch_context_full(struct ethash_epoch_context_full *context) NOEXCEPT;
